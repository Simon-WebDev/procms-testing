...
<div class="content-wrapper" style="min-height: 323px;">
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-tasks"></i> 게시판 분류<small>생성</small>
    </h1>
    <ol class="breadcrumb">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body ">
              {!! Form::open(['method'=>'post','action'=>'Backend\GroupController@store']) !!}
              ...
              <div class="form-group">
                ...
                <a href="{{route('backend.group.index')}}" class="btn btn-default btn-labeled m-l-10"><span class="btn-label"><i class="fa fa-rotate-left"></i></span>취소</a>
              </div>
              {!! Form::close() !!}  
            </div>
            <!-- /.box-body -->
